...
class ConversationRepositoryImpl @Inject constructor(
    ...
    override suspend fun postAnswer(postAnswerRequestDto: PostAnswerRequestDto): Result<ApiResponse<PostAnswerResponseData>> {
        return runCatching {
    ...
    override suspend fun getConversations(tripId: Int): Result<ApiResponse<List<GetAnswersResponseData>>> {
        return runCatching {
