package com.hyosim.hamkkae.presentation.main.trip_records.adapter
...
import com.hyosim.hamkkae.databinding.ItemTripRecordsDetailBinding
    ...
    inner class TripRecordsViewHolder(private val binding: ItemTripRecordsDetailBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(tripRecord: TripRecord) {
            with(binding){
                ...
                val textAdapter = com.hyosim.hamkkae.presentation.main.trip_records.adapter.TextAdapter()
