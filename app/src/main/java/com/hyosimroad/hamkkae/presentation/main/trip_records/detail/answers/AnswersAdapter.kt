...
import com.hyosimroad.hamkkae.databinding.ItemAnswerBinding
...
import com.hyosimroad.hamkkae.domain.model.Answer

class AnswersAdapter : ListAdapter<Answer, AnswersAdapter.AnswersViewHolder>(AnswersDiffCallback) {
    ...
    inner class AnswersViewHolder(private val binding: ItemAnswerBinding) :
        ...
        fun bind(answer: Answer) {
            with(binding) {
                ivIcon.background =
                    ContextCompat.getDrawable(root.context, R.drawable.bg_schedule_gray)
                tvNumber.apply {
                    text = answer.id.toString()
                ...
                val cardView =
                    binding.root as androidx.cardview.widget.CardView // binding.root가 CardView인 경우, 또는 binding.cvTripSchedule
